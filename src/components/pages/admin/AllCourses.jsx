...
import { GET_SUBJECTS, POST_SUBJECTS } from "../../../api/Urls";
...
const AllCourses = () => {
    // Mock initial data states
//   const [courses, setCourses] = useState([
//     { id: "C101", title: "Class 10 Advanced Math Masterclass", category: "Board Exams", price: "₹1,499" },
//     { id: "C102", title: "Math Olympiad Foundation", category: "Competitive", price: "₹2,499" },
//   ]);
const [courses, setCourses] = useState([]);
  ...
  const handleDelete = () => {
    ...
    return(
        ...
        <div className="flex min-h-screen bg-gray-50 text-gray-800 font-montserrat">
            <Sidebar pageId="allCourses" tabs={adminTabs}/>
                    ...
                    {wait ? (
                        ...
                        <div className="flex flex-col items-center p-6 bg-white rounded-2xl border border-neutral-800 shadow-2xl">
                            {/* Animated Tailwind Spinner */}
                                {/* <div className="h-16 w-16 animate-spin rounded-full border-4 border-neutral-700 border-t-blue-500" /> */}
                                <Loader className="animate-spin h-8 w-8 text-[rgba(244,87,128)] " />
                        </div>
                        </div>
                    ) :(<></>)
